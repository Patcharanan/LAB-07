...
_value	|ใช้ได้ |	
First-name |ใช้ไม่ได้ |	มีเครื่องหมาย(-)[ลบ]ทางคณิตศาตร์อยู่ในชื่อ		
Hello!	|ใช้ไม่ได้ |	มีเครื่องหมาย ! อยู่ในชื่อ
w*h 	|ใช้ไม่ได้ |	มีเครื่องหมาย(*)[คูณ]ทางคณิตศาตร์อยู่ในชื่อ		
time	|ใช้ได้ |			
do	|ใช้ไม่ได้ |	เป็นคำสงวนของภาษา C#		
Do	|ใช้ได้ |			
21November	|ใช้ไม่ได้ |	ห้ามมีตัวเลขอยู่หน้าตัวักษร		
ladkrabang	|ใช้ได้ |			
...
```
##ผลที่ได้
![](https://raw.githubusercontent.com/Patcharanan/LAB-07/dab647bd10c7878421ed8a75861ebf35c6280fc9/imgs/2.png)
...
![](https://github.com/Patcharanan/LAB-07/blob/master/imgs/4.PNG?raw=true)
